...
export const startAction = createAction('ENTITY_EDITOR_PENDING_ACTION', (id, action) => {
  return { id, action };
});

export const completeAction = createAction('ENTITY_EDITOR_COMPLETE_ACTION', (id, action) => {
  return { id, action };
});
