...
export const messageReceived = createAction('WEBSOCKET_MESSAGE_RECEIVED', (channel, message) => {
  return { channel, message };
});

export const actionReceived = createAction('WEBSOCKET_ACTION_RECEIVED', (channel, action) => {
  return { channel, action };
});

export const triggerAction = createAction('WEBSOCKET_TRIGGER_ACTION', (channel, action) => {
  return { channel, action };
});
