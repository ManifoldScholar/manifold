...
export default class AnnotationList extends PureComponent {
        ...
        <ul className="selection-list">
          <li className="annotation-detail">
            <Annotation.Selection.Wrapper
              annotation={{
                subject: "Selection with single annotation, nisi erat porttitor " +
                "ligula, eget lacinia odio sem nec elit. Maecenas sed diam eget risus" +
                " varius blandit sit amet non magna. Vivamus sagittis lacus vel augue" +
                " laoreet rutrum faucibus dolor auctor. Praesent commodo cursus magna," +
                " vel scelerisque nisl consectetur et. Selection with single annotation, " +
                "nisi erat porttitor ligula, eget lacinia odio sem nec elit. Maecenas sed " +
                "diam eget risus varius blandit sit amet non magna. Vivamus sagittis lacus" +
                " vel augue laoreet rutrum faucibus dolor auctor. Praesent commodo cursus " +
