...
import { follow, unfollow } from '../../actions/shared/authentication';
...
export default class Follow extends Component {
  ...
  handleFollow(event) {
    ...
    this.props.dispatch(follow({ id, type }));
  }
  ...
  handleUnfollow(event) {
    ...
    if (followed) {
      this.props.dispatch(unfollow(this.props.project.id, followed.id));
    }
  }
