...
import { Project, Dashboard, List } from "components/backend";
import lh from "helpers/linkHandler";

export default class BackendAdminDashboard extends PureComponent {
  static propTypes = {
            ...
            <section className="backend-dashboard">
              ...
              <div className="right">
                ...
                <section>
                  ...
                  <Dashboard.Activity statistics={this.props.statistics} />
                </section>
              </div>
            </section>
          </div>
