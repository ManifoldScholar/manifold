        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              {
                element: <UserGroup.Entitlements.List />,
                path: "entitlements",
                handle: {
                ...
                children: [
                  {
                    element: <UserGroup.Entitlements.New />,
                    path: "new",
                    handle: {
