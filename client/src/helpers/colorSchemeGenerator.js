...
export default class ColorSchemeGenerator {
  ...
  static customProperties = {
    ...
    "--color-accent-primary-light": (color) =>
      color.saturate(0.36).lighten(8.04),
    "--color-accent-primary-dull": (color) =>
      color.lighten(20).desaturate(14.56).spin(-3),
    "--color-accent-primary-pale": (color) =>
      color.lighten(25.69).saturate(5).spin(2),
    "--color-accent-primary-off-white": (color) =>
      color.lighten(35.49).desaturate(22.14).spin(5),
    ...
    "--color-interaction-dark": (color) =>
      color.darken(35.29).saturate(17.01).spin(4),
  };
