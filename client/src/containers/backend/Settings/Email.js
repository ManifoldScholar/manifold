    ...
    return (
      <section>
        <p className="instructional-copy">
          {
            'Use the settings below to configure how Manifold should send email to \
          users. Manifold supports sending mail via an external SMTP server or \
          via a local Sendmail installation. To test your configuration, press \
          the "send test email" button below. Doing so will send a message to \
          the email address on file for you user.'
          }
        </p>
        <p className="instructional-copy margin-bottom">
          <button
