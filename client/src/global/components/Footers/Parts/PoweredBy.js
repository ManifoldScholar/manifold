...
class PoweredBy extends PureComponent {
  ...
  render() {
    ...
    const logoWrapperProps = this.wrapLogoWithLink ? this.manifoldLinkProps : {};
          ...
          <div className="container flush">
            <LogoWrapper
              ...
              className={classNames({
                ...
                "app-footer-powered-by__logo--with-hover": this.isStandaloneFooter,
              ...
              {this.isReaderFooter &&
                <div className="app-footer-powered-by__copyright">
                  ...
                  <div className="app-footer-powered-by__logo-text app-footer-powered-by__logo-text--tiny">
                    Powered by Manifold Scholarship. Learn more at <a {...this.manifoldLinkProps}>manifoldapp.org</a>
                  </div>
                </div>
              }
              {this.isStandaloneFooter &&
                <span
                  className="app-footer-powered-by__logo-text"
                >
