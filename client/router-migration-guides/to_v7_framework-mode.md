...
| `src/hooks/useFrontendMode/index.js`                                  | Computes frontend mode from route matches         |
...
| `useFrontendMode()`        | Frontend mode from route matches (was Redux → context → direct) |
...
import { FrontendModeContext } from "contexts";
...
import BodyClass from "components/hoc/BodyClass";
import AppFatalError from "global/components/FatalError/AppWrapper";
