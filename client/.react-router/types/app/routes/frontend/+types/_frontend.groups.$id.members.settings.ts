...
type Module = typeof import("../_frontend.groups.$id.members.settings.js")

type Info = GetInfo<{
  file: "routes/frontend/_frontend.groups.$id.members.settings.jsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../_frontend.groups.$id.members.settings.js");
}];
