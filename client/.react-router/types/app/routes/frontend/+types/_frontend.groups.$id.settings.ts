...
type Module = typeof import("../_frontend.groups.$id.settings.js")

type Info = GetInfo<{
  file: "routes/frontend/_frontend.groups.$id.settings.jsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../_frontend.groups.$id.settings.js");
}];
