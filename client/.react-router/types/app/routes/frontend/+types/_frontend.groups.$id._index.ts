...
type Module = typeof import("../_frontend.groups.$id._index.js")

type Info = GetInfo<{
  file: "routes/frontend/_frontend.groups.$id._index.jsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../_frontend.groups.$id._index.js");
}];
