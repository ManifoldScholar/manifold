...
export default function Fields({ handleDestroy }) {
  const { t } = useTranslation();
  const { value: homepageVisible } = useFormField("attributes[homepage]");
  const { value: id } = useFormField("id");
    ...
    <>
      ...
      <Form.FieldGroup label={t("project_collections.visibility_header")}>
        ...
        <Form.Switch
          ...
          instructions={t("project_collections.exclude_from_oai_instructions")}
        />
      </Form.FieldGroup>
      <Form.FieldGroup label={t("project_collections.social_header")}>
        <Form.Upload
          ...
          instructions={t("project_collections.social_image_instructions")}
        />
        <Form.TextInput
          wide
...
Fields.displayName = "ProjectCollection.Form.Fields";
