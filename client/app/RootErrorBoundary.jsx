    ...
    <html lang="en">
      <head>
        ...
        {/* Global CSS as a virtual-DOM <style> element — survives React's
            ...
            dangerouslySetInnerHTML bypasses React's text escaping; without
            it, characters like `"` get HTML-encoded to `&quot;` inside the
            <style>, which the browser does not decode for CSS — invalidating
