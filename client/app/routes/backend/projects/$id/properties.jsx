      ...
      >
        ...
        >
          ...
          <Form.Switch
            ...
            instructions={t("projects.forms.properties.featured_instructions")}
          />
          <Form.Switch
            wide
            label={t("projects.forms.properties.finished_label")}
            name="attributes[finished]"
            instructions={t("projects.forms.properties.finished_instructions")}
          />
          <Form.Select
            ...
            options={[
              ...
              {
                value: "enabled",
                label: t("projects.forms.properties.standalone_options.enabled")
              },
              {
                value: "enforced",
                label: t(
