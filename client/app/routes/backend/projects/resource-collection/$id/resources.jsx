...
import { resourceFilters } from "hoc/withFilteredLists";
import isNil from "lodash/isNil";

const defaultFilterParams = resourceFilters.defaultParams();

export default function ResourceCollectionResources() {
  ...
  const { pagination, filters, setFilters, searchProps } = useListQueryParams({
    initSize: 5,
    initFilters: defaultFilterParams.params,
    initSearchProps: resourceFilters.dynamicParams(
      { params: defaultFilterParams.params },
      project
    )
  });
