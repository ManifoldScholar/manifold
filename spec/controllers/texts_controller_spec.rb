  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created text as @text" do
        post :create, {:text => valid_attributes}, valid_session
        expect(assigns(:text)).to be_a(Text)
        expect(assigns(:text)).to be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved text as @text" do
        post :create, {:text => invalid_attributes}, valid_session
        expect(assigns(:text)).to be_a_new(Text)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested text" do
        text = Text.create! valid_attributes
        put :update, {:id => text.to_param, :text => new_attributes}, valid_session
        text.reload
    ...
    describe "with invalid params" do
      it "assigns the text as @text" do
        text = Text.create! valid_attributes
        put :update, {:id => text.to_param, :text => invalid_attributes}, valid_session
        expect(assigns(:text)).to eq(text)
      end
