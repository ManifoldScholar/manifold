...
-  Add active state styles to EntityRow [#2082](https://github.com/ManifoldScholar/manifold/pull/2082) ([dananjohnson](https://api.github.com/users/dananjohnson))
-  Finalize entity row grid styles [#2079](https://github.com/ManifoldScholar/manifold/pull/2079) ([dananjohnson](https://api.github.com/users/dananjohnson))
-  Add service to replace files that fail to process [#2076](https://github.com/ManifoldScholar/manifold/pull/2076) ([SMaxOwok](https://api.github.com/users/SMaxOwok))
...
-  Add Lograge for production logging [#2071](https://github.com/ManifoldScholar/manifold/pull/2071) ([SMaxOwok](https://api.github.com/users/SMaxOwok))
...
-  Improve reader dark scheme styles [#2051](https://github.com/ManifoldScholar/manifold/pull/2051) ([SMaxOwok](https://api.github.com/users/SMaxOwok))
...
-  Improvements to external video external_id [#1983](https://github.com/ManifoldScholar/manifold/pull/1983) ([SMaxOwok](https://api.github.com/users/SMaxOwok))
-  Add layout config options to new project form [#1963](https://github.com/ManifoldScholar/manifold/pull/1963) ([SMaxOwok](https://api.github.com/users/SMaxOwok))
-  Add prompt and option instructions to Radios [#1962](https://github.com/ManifoldScholar/manifold/pull/1962) ([SMaxOwok](https://api.github.com/users/SMaxOwok))
-  Add unsubscribe button to backend users edit [#1945](https://github.com/ManifoldScholar/manifold/pull/1945) ([SMaxOwok](https://api.github.com/users/SMaxOwok))
-  Add drawer headers to block forms [#1815](https://github.com/ManifoldScholar/manifold/pull/1815) ([zdavis](https://api.github.com/users/zdavis))

### Bugs

-  Generate PDF thumbnails [#2073](https://github.com/ManifoldScholar/manifold/pull/2073) ([SMaxOwok](https://api.github.com/users/SMaxOwok))
...
-  Improve list styles and usages [#2064](https://github.com/ManifoldScholar/manifold/pull/2064) ([SMaxOwok](https://api.github.com/users/SMaxOwok))
...
-  Improve ListItem component markup semantics [#2053](https://github.com/ManifoldScholar/manifold/pull/2053) ([SMaxOwok](https://api.github.com/users/SMaxOwok))
...
-  Allow PC&#39;s to specify visible HP projects [#1791](https://github.com/ManifoldScholar/manifold/pull/1791) ([SMaxOwok](https://api.github.com/users/SMaxOwok))
...
-  Update method arguments [#1941](https://github.com/ManifoldScholar/manifold/pull/1941) ([zdavis](https://api.github.com/users/zdavis))
...
-  Fix OAuth sessions not setting cookie [#1900](https://github.com/ManifoldScholar/manifold/pull/1900) ([SMaxOwok](https://api.github.com/users/SMaxOwok))
...
-  Improvements to Action Callout dragging [#1888](https://github.com/ManifoldScholar/manifold/pull/1888) ([SMaxOwok](https://api.github.com/users/SMaxOwok))
