...
RSpec.describe "Project ContentBlocks API", type: :request do
  ...
  model_name_plural = 'content_blocks'

  multiple_response = { '$ref' => '#/definitions/ContentBlocksResponse' }

  create_request = { '$ref' => '#/definitions/ContentBlockCreateRequest' }
  create_response = { '$ref' => '#/definitions/ContentBlockCreateResponse' }
