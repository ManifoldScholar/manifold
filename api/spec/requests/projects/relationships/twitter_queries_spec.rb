...
RSpec.describe "Project Twitter Queries API", type: :request do
  ...
  let(:model) { FactoryBot.create(:twitter_query) }
  let(:model_id) { model[:id] }
  let(:project_id) { model[:project_id] }

  tags = ''
  model_name = 'twitter_query'
  model_name_plural = 'twitter_queries'

  get_models = { '$ref' => '#/definitions/TwitterQueriesGet' }

  create_request = { '$ref' => '#/definitions/TwitterQueryCreateRequest' }
  create_response = { '$ref' => '#/definitions/TwitterQueryCreateResponse' }
