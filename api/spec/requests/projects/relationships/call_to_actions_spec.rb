...
RSpec.describe "Project CallToActions API", type: :request do
  ...
  describe "sends a list of project call to actions" do
    let(:path) { api_v1_project_relationships_call_to_actions_path(project) }

    before(:each) { 2.times { FactoryBot.create(:call_to_action, project: project) } }
  ...
  describe "creates a content block" do
    ...
    let(:params) { {
      attributes: { kind: "table_of_contents", title: "DO IT", location: "content_top" },
