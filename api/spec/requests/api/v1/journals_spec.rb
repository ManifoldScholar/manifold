...
RSpec.describe "Journals API", type: :request do
  ...
  path "/journals/{id}" do
    ...
    it_behaves_like "an API destroy request", model: Journal, authorized_user: :admin
  end
  ...
  path "/journals" do
    ...
    it_behaves_like "an API index request", model: Journal, additional_parameters: [
    ...
    it_behaves_like "an API create request", model: Journal, authorized_user: :admin
  end
end
