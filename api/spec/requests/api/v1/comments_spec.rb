...
RSpec.describe "Comments", type: :request do
  context "for an annotation" do
    ...
    path "/annotations/{annotation_id}/relationships/comments/{id}" do
      it_behaves_like "an API show request", parent: "annotation", model: Comment, url_parameters: [:annotation_id]
      it_behaves_like "an API update request", parent: "annotation", model: Comment, url_parameters: [:annotation_id], authorized_user: :admin
      it_behaves_like "an API destroy request", parent: "annotation", model: Comment, url_parameters: [:annotation_id], authorized_user: :admin
    end
    ...
    path "/annotations/{annotation_id}/relationships/comments" do
      ...
      it_behaves_like "an API index request", parent: "annotation", model: Comment, url_parameters: [:annotation_id], paginated: true, included_relationships: [:creator]
    end
  end
  ...
  context "for a resource" do
    ...
    path "/resources/{resource_id}/relationships/comments/{id}" do
      it_behaves_like "an API show request", parent: "resource", model: Comment, url_parameters: [:resource_id]
      it_behaves_like "an API update request", parent: "resource", model: Comment, url_parameters: [:resource_id], authorized_user: :admin
      it_behaves_like "an API destroy request", parent: "resource", model: Comment, url_parameters: [:resource_id], authorized_user: :admin
    end
  ...
  path "/comments/{id}" do
    it_behaves_like "an API show request", model: Comment
    it_behaves_like "an API update request", model: Comment, authorized_user: :admin
    it_behaves_like "an API destroy request", model: Comment, authorized_user: :admin
  end
