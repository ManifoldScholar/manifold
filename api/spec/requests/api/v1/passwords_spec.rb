...
RSpec.describe "Passwords", type: :request do
  ...
  path "/passwords" do
    include_examples "an API create request",
                      ...
                      summary: "Sends a reset password token to the email provided if it is associated with a user",
                      parameters: [
  ...
  path "/passwords/update" do
    include_examples "an API update request",
                      model: User,
                      summary: "Updates the password for the user associated with the password reset token",
                      tags: "Passwords",
                      parameters: [
