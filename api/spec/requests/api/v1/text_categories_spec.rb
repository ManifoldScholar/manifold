...
RSpec.describe "Text Categories", type: :request do
  describe "for a project" do
    ...
    path "/projects/{project_id}/relationships/text_categories" do
      include_examples "an API index request", parent: "project", model: Category, resource_name: "text_category", url_parameters: [:project_id]
      include_examples "an API create request", parent: "project", model: Category, resource_name: "text_category", url_parameters: [:project_id], authorized_user: :admin
    end
