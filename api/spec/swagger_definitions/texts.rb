        ...
        data: Type.object({
          ...
          relationships: Type.object({
            project: Type.object({
              ...
              stylesheets: Type.object({
                data: Type.array( type: Type.string ) #TODO unsure about all these
              }),
              creators: Type.object({
                data: Type.array( type: Type.string ) #TODO unsure about all these
              }),
              ...
              textSections: Type.object({
                data: Type.array( type: Type.string ) #TODO unsure about all these
                }),
              tocSection: Type.object({
                data: Type.nullable_string  #TODO unsure about all these
              })
            }),
