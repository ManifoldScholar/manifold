...
RSpec.describe Ingestor::Strategy::GoogleDoc::Builder do
  ...
  before(:each) do
    ...
    # test doc set up for public view with url
    path = "https://docs.google.com/document/d/17BvIshHwb1oW7kwDLfIFMrLgxmFHXRaDci5USHblEFs"
