...
RSpec.describe Ingestor::Transformer::TextSection do
  ...
  context "when converting body URIs" do
    it "rescues from empty body tags" do
      body = nil
  ...
  context "when converting body to json" do
    it "rescues from empty body tags" do
      body = nil
      text.text_sections << TextSection.new(body: body)
      expect { subject.convert_cont_doc_body_to_json body }.not_to raise_error
    end
  end
