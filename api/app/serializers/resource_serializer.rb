...
class ResourceSerializer < ResourcePartialSerializer
  ...
  attributes :title, :kind, :attachment_file_name, :attachment_extension,
             ...
             :high_res_file_name, :high_res_content_type, :high_res_file_size, :high_res_updated_at,
             :variant_format_one_file_name, :variant_format_one_content_type, :variant_format_one_file_size,
             :variant_format_one_updated_at, :variant_format_two_file_name, :variant_format_two_content_type,
             :variant_format_two_file_size, :variant_format_two_updated_at, :variant_thumbnail_styles,
             :variant_thumbnail_file_name, :variant_thumbnail_content_type, :variant_thumbnail_file_size,
             :variant_thumbnail_updated_at, :variant_poster_styles, :variant_poster_file_name,
             :variant_poster_content_type, :variant_poster_file_size, :variant_poster_updated_at,
