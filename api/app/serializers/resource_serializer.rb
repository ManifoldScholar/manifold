...
class ResourceSerializer < ActiveModel::Serializer
  ...
  attributes :title, :type , :attachment_file_name, :attachment_content_type,
             :attachment_file_size, :attachment_updated_at, :created_at, :updated_at,
             :project_id, :caption, :description, :fingerprint, :keywords, :alt_text,
