module V1
  class ProjectSerializer < ManifoldSerializer
    ...
    typed_attribute :title, Types::String # required
    typed_attribute :subtitle, Types::String.optional
    typed_attribute :subtitle_formatted, Types::String
    typed_attribute :subtitle_plaintext, Types::String
    typed_attribute :title_formatted, Types::String
    typed_attribute :title_plaintext, Types::String
    typed_attribute :publication_date, Types::DateTime.optional
    typed_attribute :created_at, Types::DateTime
    typed_attribute :updated_at, Types::DateTime
    ...
    typed_attribute :avatar_meta, Types::Hash
    ...
    typed_attribute :avatar_styles, Types::Serializer::Attachment
    ...
    when_full do
      ...
      typed_attribute :hero_styles, Types::Serializer::Attachment
      typed_attribute :cover_styles, Types::Serializer::Attachment
      ...
      typed_attribute :description_formatted, Types::String
      typed_attribute :resource_kinds, Types::Array.of(Types::String)
      typed_attribute :dark_mode, Types::Bool
      typed_attribute :image_credits, Types::String.optional
      typed_attribute :image_credits_formatted, Types::String
      typed_attribute :tag_list, Types::Array.of(Types::String)
      typed_attribute :resource_collections_count, Types::Integer
      typed_attribute :resources_count, Types::Integer
      ...
      typed_attribute :event_count, Types::Integer, &:filtered_event_count
      typed_attribute :event_types, Types::Array.of(Types::String), &:uniq_event_types
      typed_attribute :resource_tags, Types::Array.of(Types::String), &:sorted_resource_tags
