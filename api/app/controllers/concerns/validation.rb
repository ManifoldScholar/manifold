...
module Validation
  ...
  def project_params
    ...
    attributes = [:title, :subtitle, :featured, :hashtag, :description, :purchase_url,
                  ...
                  :social_description, :external_identifier, :exclude_from_oai, :exclude_from_directory, :license]
  ...
  def journal_params
    ...
    attributes = [:title, :subtitle, :hashtag, :description, :facebook_id, :twitter_id,
                  ...
                  :exclude_from_oai, :exclude_from_directory, :license]
  ...
  def project_collection_params
    ...
    attributes = [:title, :sort_order, :visible, :homepage, :smart, :position, :icon,
                  ...
                  :social_title, attachment(:social_image), :remove_social_image, :external_identifier, :exclude_from_oai]
  ...
  def user_group_membership_params
    params.require(:data)
    attributes = []
    relationships = [:user]
    param_config = structure_params(attributes: attributes, relationships: relationships)
