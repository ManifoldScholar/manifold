SELECT
  ...
  LEFT JOIN LATERAL (
    SELECT
      titles #>> '{main,raw}' AS title,
      titles #>> '{subtitle,raw}' AS subtitle,
      titles #>> '{main,formatted}' AS title_formatted,
      titles #>> '{subtitle,formatted}' AS subtitle_formatted,
      titles #>> '{main,plaintext}' AS title_plaintext,
      titles #>> '{subtitle,plaintext}' AS subtitle_plaintext
    FROM text_titles tt
