...
ActiveRecord::Schema.define(version: 20190201200513) do
  ...
  create_table "action_callouts", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.index ["project_id"], name: "index_action_callouts_on_project_id", using: :btree
    t.index ["text_id"], name: "index_action_callouts_on_text_id", using: :btree
  end
