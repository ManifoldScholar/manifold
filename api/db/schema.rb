...
ActiveRecord::Schema.define(version: 2023_05_19_033907) do
  ...
  create_table "journals", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.integer "events_count", default: 0
    t.jsonb "hero_data"
    t.integer "hero_layout", default: 0
  ...
  create_table "projects", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.index ["journal_issue_id"], name: "index_projects_on_journal_issue_id", unique: true
  ...
  create_table "texts", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.string "description"
    t.text "toc_legacy"
    t.text "page_list_legacy"
    t.text "landmarks_legacy"
    t.text "structure_titles_legacy"
    t.uuid "project_id"
    t.uuid "category_id"
    t.uuid "creator_id"
    ...
    t.jsonb "fa_cache", default: {}, null: false
    t.jsonb "toc", default: [], null: false
    t.jsonb "page_list", default: [], null: false
    t.jsonb "landmarks", default: [], null: false
    t.jsonb "structure_titles", default: {}, null: false
